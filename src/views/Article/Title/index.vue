...
const toUpload = async (file) => {
  ...
  formData.append('parent', String(route.query.aid))
    ...
    <Container :content="JSON.stringify(body)">
      <div w-full flex>
        ...
        <div class="right" ml-24px w-232px bt-12px mr-18px>
          ...
          <div text-14px line-height-24px text="#8f959e">暂无描述</div>
          <div text-12px line-height-24px mt-12px text="#646973">所有者</div>
          <div text-14px line-height-24px text="#1f2329">黄原寅</div>
        </div>
      </div>
    </Container>
  </div>
