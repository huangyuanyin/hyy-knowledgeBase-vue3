...
<template>
  <div class="drawer-wrapper">
    <el-drawer v-model="isShowDrawer" :direction="direction" :append-to-body="false" :z-index="10 ** 10000" :with-header="false" size="65%">
      <el-row>
        <el-col :span="4">
          <el-menu class="elMenu-wrap" default-active="" style="width: 200px">
            ...
            <div style="height: calc(100vh - 160px)">
              <template v-for="(item, _index) in productList" :key="'productList' + _index">
          ...
          <el-card class="right-menu" style="left: 200px; width: calc(100% - 200px)">
            <template #header>
              <div class="header-warp">
                ...
                <el-icon class="closeButton" @click="handleClose"><Close /></el-icon>
              </div>
            </template>
