...
!(function () {
  ...
  function o(t) {
    Qeider = t
    t.ui.registry.getAll().icons.attachment ||
      ...
      t.ui.registry.addButton('attachment', {
        icon: 'attachment',
        tooltip: '插入附件',
        onAction: function () {
          return i(t)
  ...
  var e = function (n) {
    ...
    r = function (a, t, n) {
      var e,
        ...
        _,
        f,
        s = a.getParam('attachment_max_size') || 209715200
      ...
      t.size > s
        ...
        : ((i = a.getParam('attachment_upload_handler')),
          (o = a.getParam('attachment_icons_path', './plugins/attachment/icons')),
          (c = a.dom.uniqueId()),
          (r = 'attachment_' + c),
          (l = d(t.size)),
          (p =
            ...
            (function (e) {
              if (e) {
                ...
                for (
                  var n = e.substr(t + 1).toLowerCase(),
                    i = 0,
                    o = [
                      {
                        ext: 'txt',
    ...
    e.__proto__.getContent = (function (_g) {
      return function () {
        return arguments && arguments.length == 0
          ? '<style>' +
              e.getParam('attachment_style', '.attachment>img{display:inline-block!important;max-width:30px!important;}.attachment>a{display:contents!important;}', 'string') +
              '</style>' +
              _g.apply(this, arguments).replace(/<style>([\S\s\t]*?)<\/style>/gi, '')
          : _g.apply(this, arguments)
      }
    })(e.__proto__.getContent)
    var n, c
    o(e),
      (n = e).addCommand('mceAttachment', function () {
        i(n)
      }),
